...
\include{solution_chapter/solution8}

\chapter{Change of Basis and $F$-Matrices}
\include{solution_chapter/solution9}

\chapter{Exchanging Identical Particles}
\include{solution_chapter/solution10}

\chapter{Computing with Anyons}
\include{solution_chapter/solution11}

\part{Anyon Diagrammatics (in detail)}

\chapter{Planar Diagrams}
\include{solution_chapter/solution12}

\chapter{Braiding Diagrams}
\include{solution_chapter/solution13}

\chapter{Seeking Isotopy}
\include{solution_chapter/solution14}

\chapter{Twists}
\include{solution_chapter/solution15}

\chapter{Theories with Tetrahedral Symmetry (or Full Isotopy)}
\include{solution_chapter/solution16}

\chapter{Further Structure}
\include{solution_chapter/solution17}
