...
(b) Since this is a finite group, every element have a finite order. So the simplest way is to apply an element as many times as possible to feel the group structure. Consider $\sigma _{1}$(same as $\sigma _{2}$) first:
\begin{figure}[h!]
\centering
...
\paragraph{Answer}
Suppose there is a theory that $a\times a=a$ and $a\neq I$, then consider the process of fusing $a,a$ and $\bar{a}$. As the Fig.\ref{fig:fusionOfThreeAnyons} below shows, if we fuse $a\times a=a$ first, then fuse $a\times \bar{a} =I$, we will get $I$ finally. However, if we change the order of fusion, fuse $a\times \bar{a}$ first and get $I$, then fuse $a\times I=a$, we will get $a$. We know that the order of fusion doesn't change final result, so $a=I$. So if $a\times a=a$, we can only have the trivial case, i.e. $I\times I=I$. 
\begin{figure}[h!]
\centering
\tikzset{every picture/.style={line width=0.75pt}} %set default line width to 0.75pt        
...
%Straight Lines [id:da4634021555868877] 
\draw [color={rgb, 255:red, 74; green, 144; blue, 226 }  ,draw opacity=1 ]   (152,12) -- (242,102) ;
%Straight Lines [id:da42758131788998166] 
\draw [color={rgb, 255:red, 74; green, 144; blue, 226 }  ,draw opacity=1 ]   (182,42) -- (212,12) ;
%Straight Lines [id:da8949097389354259] 
\draw [color={rgb, 255:red, 74; green, 144; blue, 226 }  ,draw opacity=1 ]   (212,72) -- (272,12) ;

%Straight Lines [id:da44546381784505296] 
\draw [color={rgb, 255:red, 74; green, 144; blue, 226 }  ,draw opacity=1 ]   (369,12) -- (459,102) ;
%Straight Lines [id:da679345298037608] 
\draw [color={rgb, 255:red, 74; green, 144; blue, 226 }  ,draw opacity=1 ]   (459,42) -- (429,12) ;
%Straight Lines [id:da5199619955313683] 
\draw [color={rgb, 255:red, 74; green, 144; blue, 226 }  ,draw opacity=1 ]   (429,72) -- (489,12) ;


% Text Node
\draw (320,46) node [anchor=north west][inner sep=0.75pt]    {$=$};
% Text Node
\draw (163,6) node [anchor=north west][inner sep=0.75pt]    {$a$};
% Text Node
\draw (220,6) node [anchor=north west][inner sep=0.75pt]    {$a$};
% Text Node
\draw (280,6) node [anchor=north west][inner sep=0.75pt]    {$\bar{a}$};
% Text Node
\draw (180,56) node [anchor=north west][inner sep=0.75pt]    {$a$};
% Text Node
\draw (250,86) node [anchor=north west][inner sep=0.75pt]    {$I$};
% Text Node
\draw (380,6) node [anchor=north west][inner sep=0.75pt]    {$a$};
% Text Node
\draw (440,6) node [anchor=north west][inner sep=0.75pt]    {$a$};
% Text Node
\draw (497,6) node [anchor=north west][inner sep=0.75pt]    {$\bar{a}$};
% Text Node
\draw (447,56) node [anchor=north west][inner sep=0.75pt]    {$I$};
% Text Node
\draw (467,86) node [anchor=north west][inner sep=0.75pt]    {$a$};
\end{tikzpicture}
